...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPref = "com.example.android.hellosharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCount = mSharedPref.getInt(COUNT_KEY, 0);
        mColor = mSharedPref.getInt(COLOR_KEY, mColor);
    ...
    protected void onPause() {
        ...
        mEditor.putInt(COUNT_KEY, mCount);
        mEditor.putInt(COLOR_KEY, mColor);
        mEditor.apply();
    }
    ...
    public void reset(View view) {
        ...
        SharedPreferences.Editor preferences = mSharedPref.edit();
        preferences.clear();
        preferences.apply();
    }
}
